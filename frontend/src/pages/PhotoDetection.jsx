...
import { LogOut, ArrowLeft, Video } from 'lucide-react'
      ...
      <main className="dash-content">
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '10px' }}>
            ...
            >
              <Video size={32} style={{ color: 'var(--purple-400)' }} />
            </motion.div>
            <h1 className="text-gradient">Video & Photo Analysis</h1>
          </div>
          <p style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
            <span>Detect deepfakes in images and videos with our AI-powered analysis</span>
          </p>
        </motion.div>
